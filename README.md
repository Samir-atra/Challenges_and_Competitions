...
*   **Reference:** @misc{ml-olympiad-predicting-earthquake-damage,
    author = {Tensor Girl},
...
*   **Reference:** @misc{fake-or-real-the-impostor-hunt,
...
*   ** Reference:** @misc{google-code-golf-2025,
